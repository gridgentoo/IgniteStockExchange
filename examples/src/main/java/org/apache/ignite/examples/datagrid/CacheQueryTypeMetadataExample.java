 ...
 */
public class CacheQueryTypeMetadataExample {
    /** Organizations cache name. */
    private static final String ORG_CACHE = CacheQueryTypeMetadataExample.class.getSimpleName() + "Organizations";

    /** Persons cache name. */
    private static final String PERSON_CACHE = CacheQueryTypeMetadataExample.class.getSimpleName() + "Persons";

    /**
     * @return Organisation type metadata.
     */
    private static Collection<CacheTypeMetadata> orgTypeMetadata() {
        Collection<CacheTypeMetadata> types = new ArrayList<>();

        CacheTypeMetadata type = new CacheTypeMetadata();
        type.setValueType(Organization.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            // Configure cache for Organizations.
            ...
            orgCacheCfg.setTypeMetadata(orgTypeMetadata());

            // Configure cache for Persons.
            CacheConfiguration<AffinityKey<UUID>, Person> personCacheCfg = new CacheConfiguration<>(PERSON_CACHE);
            personCacheCfg.setCacheMode(CacheMode.PARTITIONED);
            personCacheCfg.setTypeMetadata(personTypeMetadata());
            ...
            print("Cache query type metadata example finished.");
        }
    }
